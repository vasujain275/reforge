...
ALTER TABLE attempts ADD COLUMN timer_last_updated_at TEXT;
...
ALTER TABLE attempts DROP COLUMN elapsed_time_seconds;
ALTER TABLE attempts DROP COLUMN timer_state;
ALTER TABLE attempts DROP COLUMN timer_last_updated_at;
ALTER TABLE attempts DROP COLUMN started_at;
